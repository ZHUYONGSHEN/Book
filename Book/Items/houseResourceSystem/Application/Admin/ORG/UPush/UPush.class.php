...
class UPush {
	...
	function sendAndroidBroadcast($title='', $description='', $production_mode='true', $ticker='通知') {
		try {
			...
			$brocast->setPredefinedKeyValue("text",             $description);
	...
	function sendIOSBroadcast($alert='', $description='', $production_mode='true') {
		try {
			...
			$brocast->setPredefinedKeyValue("description", $description);
			// print("Sending broadcast notification, please wait...\r\n");
			return $brocast->send();
			// print("Sent SUCCESS\r\n");
		} catch (\Exception $e) {
