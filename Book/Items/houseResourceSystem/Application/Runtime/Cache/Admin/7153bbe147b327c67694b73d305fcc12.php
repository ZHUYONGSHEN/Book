		...
		<form class="form-horizontal" method="post" enctype="multipart/form-data">
			<div class=" hoMain-body background-white border EditBootstrap">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="col-sm-4">
                            <div class="upDataImage upDataFile" id="upDataImage" data-elemShow ="upDataImage" data-upDataUrl="<?php echo U('Dictionary/ImgUpload');?>" data-Type="png/jpg/jpeg" data-fileSize="5" data-fileWidth="1200" data-fileheight="900"></div>
                        </div>
